...
<div class="navigation">
  <ul>
    ...
    <li>
      <a onclick="window.location.href='<?php echo PUBLIC_PATH ?>view/dashboard-manager.php';">
        <span class="icon">
    ...
    <li>
      <a onclick="window.location.href='<?php echo PUBLIC_PATH ?>view/order-history-manager.php';">
        <span class="icon">
